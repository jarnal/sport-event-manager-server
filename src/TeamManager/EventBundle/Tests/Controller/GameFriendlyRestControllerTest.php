...
use TeamManager\EventBundle\DataFixtures\ORM\LoadGameFriendlyData;
...
class GameFriendlyRestControllerTest extends EntityRestControllerTest {
    ...
    {
        return array_pop(LoadGameFriendlyData::$games);
    }
