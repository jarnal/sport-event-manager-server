...
class CommentService extends EntityRestService
{
    ...
    /**
     * {@inheritdoc}
     * In the case of a comment, the player has to be in the related game to allow comment to be set.
     * Impossible to add a comment to a player that is not in the passed event.
     *
